    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            $statement->execute(array(
                                   ...
                                   $_POST['about_content'],
                                   $final_name,
                                   $_POST['about_meta_title'],
                                   $_POST['about_meta_keyword'],
                                   $_POST['about_meta_description']
                                ));
...
if(isset($_POST['form_faq'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            $statement->execute(array($_POST['faq_title'],
                                      $final_name,$_POST['faq_meta_title'],
                                      $_POST['faq_meta_keyword'],
                                      $_POST['faq_meta_description']));
        } else {
            // updating the database
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            $statement->execute(array($_POST['blog_title'],
                                      $final_name,$_POST['blog_meta_title'],
                                      $_POST['blog_meta_keyword'],
                                      $_POST['blog_meta_description']));
        } else {
            // updating the database
...
if(isset($_POST['form_vgallery'])) {
    ...
    if($path != '') {
        $ext = pathinfo( $path, PATHINFO_EXTENSION );
        $file_name = basename( $path, '.' . $ext );
        if( $ext!='mp4' && $ext!='MP4' && $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' && $ext!='JPG' && $ext!='PNG' && $ext!='JPEG' && $ext!='GIF'  ) {
            $valid = 0;
            $error_message .= 'You must have to upload jpg, jpeg, gif or png file<br>';
        }
    }
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6" style="padding-top:6px;">
                                                ...
                                                <?php 
                                               // $path = mime_content_type($vgallery_banner);
                                                $path=  "../assets/uploads/".$vgallery_banner;
                                              ...
                                              <?php  }
                                                ...
                                                <source src="../assets/uploads/<?php echo $vgallery_banner;  ?>" type="video/mp4"/>
