    ...
    if($valid == 1) {
    	...
    	if( isset($_FILES['photo']["name"]) && isset($_FILES['photo']["tmp_name"]) )
        {
            ...
            for($i=0;$i<count($photo);$i++)
            {
		        ...
		        if ( $my_ext1=='jpg' || $my_ext1=='png' || $my_ext1=='jpeg' || $my_ext1=='gif' || $ext!='JPG' || $ext!='PNG' || $ext!='JPEG' || $ext!='GIF' ) {
    	...
    	unset($_POST['p_name']);
    	unset($_POST['p_old_price']);
    	unset($_POST['p_current_price']);
    	unset($_POST['p_description']);
    	unset($_POST['p_short_description']);
    	unset($_POST['p_feature']);
    	unset($_POST['p_condition']);
    	unset($_POST['p_return_policy']);
    	unset($_POST['p_is_featured']);
    	unset($_POST['p_is_active']);
    	unset($_POST['ecat_id']);
    	unset($_POST['mcat_id']);
				...
				<div class="box box-info">
					...
					<!--
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea name="p_short_description" class="form-control" cols="30" rows="10" ></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Features</label>
							<div class="col-sm-8">
								<textarea name="p_feature" class="form-control" cols="30" rows="10" id="editor2"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Conditions</label>
							<div class="col-sm-8">
								<textarea name="p_condition" class="form-control" cols="30" rows="10" id="editor3"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Return Policy</label>
							<div class="col-sm-8">
								<textarea name="p_return_policy" class="form-control" cols="30" rows="10" id="editor4"></textarea>
							</div>
						</div>
						<div class="form-group">
